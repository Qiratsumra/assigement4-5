...
export default function About(){
    return(
        <div className="sm: h-auto w-auto flex justify-center p-10 font-serif">
        <div className=" sm: text-center divide-solid rounded-xl text-white  bg-gray-900 h-[650px] w-[500px] about shadow-drop-2-bottom">
