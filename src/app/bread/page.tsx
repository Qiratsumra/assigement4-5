...
export default function Bread(){
    return(
        <div className="flex justify-center">
            <div className="card2  text-center divide-solid rounded-xl sm: h-[1600px] w-[700px] bg-card m-10">
            <Image src={bread} alt="breakFast" className="p-7 rounded-xl flex items-center justify-center h-[300px]"></Image>
            <h1 className="text-4xl font-serif font-bold">Chicken Bread</h1>
            
            <p className="">The chicken bread is one of my favourite braided and stuffed breads. Below are the step by step instructions with pics on how to make the recipe.
            </p>
            <br />
                <h2 className="text-2xl font-serif text-orange-900 font-bold">Ingredients for Dough</h2>
                <br />
                <ul className="">
                ...
                <br />
                <h2 className="text-2xl font-serif text-orange-900 font-bold">Ingredients for Chicken Filling</h2>
                <br />
                <ol className="">
                ...
                <br />
                <h3 className="text-xl font-serif text-orange-900 font-bold">Chicken Filling</h3>
                <ol>
