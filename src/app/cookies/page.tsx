...
export default function Cookies(){
    return(
        <div className="font-serif flex justify-center text-center">
        <div className="card3  text-center divide-solid rounded-xl sm: h-[1100px] w-[700px]  bg-card m-10">
          <Image src={biscutes} alt="breakFast" className="p-7 rounded-xl flex items-center justify-center h-[400px]"></Image>  
          <h1 className="text-4xl">Butter Cookies</h1>
         ...
         <p className="p-4">Preheat oven to 450°F (230°C). In a large mixing bowl, whisk together flour, baking powder, salt, and sugar (if using).
