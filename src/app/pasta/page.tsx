...
export default function Pasta(){
    return(
        <div className="flex justify-center font-serif max-sm:p-10 px-10 max-sm:m-24">
             <div className="card2  text-center divide-solid rounded-xl h-[950px] w-[700px] bg-card m-10 max-sm:text-center max-sm:divide-solid max-sm:rounded-lg max-sm:h-[900px] max-sm:w-[800px]">
             <Image src={pasta} alt="pasta" className="p-2 rounded-xl flex items-center justify-center h-[270px] w-[700px] max-sm:rounded-xl max-sm:flex max-sm:items-center max-sm:justify-center max-sm:h-[170px] max-sm:w-[700px]"></Image>
             <h1 className="text-4xl max-sm:text-2xl">Creamy Garlic Parmesan Pasta</h1>
             <p className="text-xl max-sm:text-[10px] max-sm:font-bold"><q>The perfect meal for me is pasta with a little bit of cheese 🍽️🌍</q></p>
             <br />
             <h2 className="text-2xl  text-orange-900 font-bold max-sm:text-xl">Ingredients:</h2>
             <ol className="max-sm:text-[6px] max-sm:font-bold">
